...
You can find the official java documentation [here](https://docs.oracle.com/en/java/javase/11/docs/api/#JavaSE). I will post additional resources that we use throughout the course as well.
